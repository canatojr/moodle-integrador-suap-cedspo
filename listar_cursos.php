...
<dl class='oneline'>
  <dt>Ano:</dt>
  <dd><input name='ano' type='number' min='<?php echo $suap_min_year; ?>' max='<?php echo $current_year; ?>' step='1' value="<?php echo $ano; ?>" /></dd>
  <dt>Período:</dt>
...
<table class="table">
  <thead>
    <tr><th>ID</th><th>Código</th><th>Nome</th><th>Descrição</th><th>Ação</th></tr>
  </thead>
  <tbody>
    <?php
